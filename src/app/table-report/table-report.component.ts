import { Component, OnInit, Input, Optional, ViewChild, ContentChildren, QueryList } from '@angular/core';
import { trigger, state, style, transition, animate } from '@angular/animations';
import { MatTable, MatColumnDef, MatRowDef, MatHeaderRowDef, MatFooterRowDef } from '@angular/material/table';
